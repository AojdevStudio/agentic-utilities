...
for (const file of files) {
  ...
  if (!isNonEmptyString(name)) errors.push(`${file}: missing required frontmatter field: name`);
  else {
  ...
  if (!isNonEmptyString(description)) errors.push(`${file}: missing required frontmatter field: description`);
